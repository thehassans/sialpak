        ...
        {!editing ? (
          ...
          <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select className="admin-select" value={editing.position} onChange={(e) => setEditing({ ...editing, position: e.target.value })}>
                    ...
                    <option value="strip">Sale Strip</option>
                  </select>
                </div>
              </div>
            ...
            <div>
              ...
              <div
                className="rounded-2xl overflow-hidden relative min-h-[280px] flex items-center p-8 sticky top-6"
              ...
              <p className="text-[11px] text-sub mt-2 text-center">This preview reflects exactly how the banner renders on your live homepage.</p>
            </div>
          </div>
        )}
      </div>
