    ...
    <section className="py-12 relative overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        <div className="rounded-3xl overflow-hidden relative bg-gradient-to-r from-brand to-navy min-h-[380px] flex items-center justify-center py-16 px-6">
          ...
          >
            <Image src="https://picsum.photos/seed/promo1/300/300" alt="Decoration" fill className="object-cover rounded-full blur-[2px]" />
          </motion.div>
          ...
          >
            <Image src="https://picsum.photos/seed/promo2/300/300" alt="Decoration" fill className="object-cover rounded-full blur-[1px]" />
          </motion.div>
